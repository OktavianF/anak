...
import { ArrowLeft, MessageSquare, Heart, Share2, MoreVertical, Users, TrendingUp, Clock, Home, BarChart3, User, Sparkles, Award, HelpCircle, Trophy, UserCheck, MessageCircle, Plus, BookOpen, Star, CheckCircle, Crown } from 'lucide-react';
...
export default function CommunityScreen({ navigateTo, childName, isParentMode }: CommunityScreenProps) {
  ...
  const posts = [
    {
      id: 1,
      author: 'Bunda Sarah',
      authorAvatar: 'https://images.unsplash.com/photo-1549633564-3ab4c92ff2d3?w=100&h=100&fit=crop&auto=format',
      timeAgo: '2 jam lalu',
      content: 'Anak saya (7th) baru mulai belajar membaca. Ada tips untuk membuat dia lebih semangat? Dia sering merasa bosan dengan buku bacaan biasa.',
      likes: 12,
      comments: 8,
      ...
      replies: [
        {
          author: 'Mama Rina',
          content: 'Coba pakai buku bergambar yang interaktif, atau baca bersama dengan suara yang ekspresif!'
        },
        {
          author: 'Papa Doni',
          content: 'Anak saya suka banget kalau ceritanya tentang hewan atau superhero. Mungkin bisa dicoba?'
        }
      ]
    },
    {
      id: 2,
      author: 'Papa Ahmad',
      authorAvatar: 'https://images.unsplash.com/photo-1583249283649-c3bbbbafb5a8?w=100&h=100&fit=crop&auto=format',
      timeAgo: '5 jam lalu',
      content: 'Sharing hasil tes kognitif anak saya hari ini: Matematika 85%, Bahasa 92%! Alhamdulillah ada peningkatan dari bulan lalu. Terima kasih tips dari komunitas ini 🙏',
      likes: 24,
      comments: 15,
      category: 'Pencapaian'
    },
    {
      id: 3,
      author: 'Mama Lisa',
      authorAvatar: 'https://images.unsplash.com/flagged/photo-1553906789-3e7757f41ae7?w=100&h=100&fit=crop&auto=format',
      timeAgo: '1 hari lalu',
      content: 'Ada yang punya pengalaman dengan anak yang susah fokus saat belajar? Anak saya (6th) sering teralihkan perhatiannya. Sudah coba berbagai cara tapi belum berhasil.',
      likes: 18,
      comments: 22,
      category: 'Konsultasi',
      replies: [
        {
          author: 'Dr. Maya',
          content: 'Coba buat jadwal belajar dalam sesi pendek 15-20 menit dengan istirahat. Konsistensi sangat penting.',
          isExpert: true
        }
      ]
    },
    {
      ...
      authorAvatar: 'https://images.unsplash.com/photo-1549633564-3ab4c92ff2d3?w=100&h=100&fit=crop&auto=format',
      timeAgo: '2 hari lalu',
      content: 'Game puzzle di app ANAK sangat membantu melatih logika anak saya! Sekarang dia lebih cepat dalam menyelesaikan masalah. Recommended banget!',
      likes: 31,
      comments: 12,
      category: 'Review'
    }
  ...
  const topics = [
    { id: 'popular', label: 'Populer', icon: Sparkles, color: 'text-amber-500', bgColor: 'bg-amber-50', borderColor: 'border-amber-200' },
    { id: 'recent', label: 'Terbaru', icon: Clock, color: 'text-blue-500', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
    { id: 'question', label: 'Q&A', icon: HelpCircle, color: 'text-emerald-500', bgColor: 'bg-emerald-50', borderColor: 'border-emerald-200' },
    { id: 'achievement', label: 'Pencapaian', icon: Award, color: 'text-purple-500', bgColor: 'bg-purple-50', borderColor: 'border-purple-200' }
  ];

  const communityStats = [
    { label: 'Anggota Aktif', value: '2.8K', icon: UserCheck, color: 'text-emerald-400', bgColor: 'bg-emerald-100/50' },
    { label: 'Diskusi Bulan Ini', value: '456', icon: MessageCircle, color: 'text-blue-400', bgColor: 'bg-blue-100/50' },
    { label: 'Tips Dibagikan', value: '89', icon: BookOpen, color: 'text-amber-400', bgColor: 'bg-amber-100/50' }
  ];
          ...
          {posts.map((post, index) => {
            const getCategoryStyle = (category: string) => {
              switch (category) {
                ...
                case 'Pencapaian':
                  return { bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200', icon: Trophy };
                case 'Konsultasi':
                  return { bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200', icon: HelpCircle };
                case 'Review':
                  return { bg: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-200', icon: Star };
                default:
                  return { bg: 'bg-slate-50', text: 'text-slate-700', border: 'border-slate-200', icon: MessageSquare };
              }
            };
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <div className={`flex items-center space-x-1.5 px-2 py-1 rounded-lg border ${categoryStyle.bg} ${categoryStyle.text} ${categoryStyle.border}`}>
