...
import { useChc } from './hooks/useChc';
...
export default function App() {
  ...
  const navigateTo = (screen: string, data?: Record<string, unknown>) => {
  ...
  const updateSurveyData = (newData: Partial<typeof surveyData>) => {
  ...
  // (login flow handled inline where needed)
    ...
    if (appMode === 'child') {
      ...
      switch (currentScreen) {
        ...
        case 'word-puzzle-game':
          return (
            <WordPuzzleGameScreen {...commonProps} updateGameAssessment={updateChcAssessment} />
          );
        ...
        case 'pattern-recognition-game':
          return (
            <PatternRecognitionGameScreen
              {...commonProps}
              updateGameAssessment={updateChcAssessment}
            />
          );
      ...
      case 'cognitive-test':
        return (
          <CognitiveTestScreen
            {...commonProps}
            childName={childName}
            updateTestResults={updateChcTestResults}
          />
        );
