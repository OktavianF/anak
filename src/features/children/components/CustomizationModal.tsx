      ...
      >
        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
          {currentOptions.map((item, index) => (
            <button
              key={index}
              onClick={() => onPurchase(item, 100)}
              className="aspect-square bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl flex items-center justify-center text-2xl hover:scale-105 transition-transform border-2 border-transparent hover:border-purple-300 relative"
            >
              {item}
