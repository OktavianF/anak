...
import { coloringImages, getDifficultyColor } from '../components/coloring/coloringData';
import CompletionScreen from '../components/coloring/CompletionScreen';
...
export default function ColoringGameScreen({ navigateTo, addSticker }: ColoringGameScreenProps) {
  ...
  const handleAreaColor = (areaId: string) => {
    ...
    if (selectedImage && Object.keys(newColoredAreas).length === selectedImage.areas) {
      setIsCompleted(true);
